...
if [[ -z "$BuildSemanticVersion" ]]; then
    ...
    export BuildSemanticVersion="99.99.99-dev-$autoVersion"
    autoGeneratedVersion=true
    
    echo "Set version to $BuildSemanticVersion"
fi

sed -i '' "s/99.99.99-dev/$BuildSemanticVersion/g" */*/project.json
...
sed -i '' "s/$BuildSemanticVersion/99.99.99-dev/g" */*/project.json
