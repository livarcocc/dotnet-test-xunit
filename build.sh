...
if [[ -z "$BuildSemanticVersion" ]]; then
    ...
    export BuildSemanticVersion="0.0.0-dev-$autoVersion"
    autoGeneratedVersion=true
    
    echo "Set version to $BuildSemanticVersion"
fi

sed -i '' "s/0.0.0-dev/$BuildSemanticVersion/g" */*/project.json
...
sed -i '' "s/$BuildSemanticVersion/0.0.0-dev/g" */*/project.json
